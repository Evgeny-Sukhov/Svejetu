...
$lang = array_merge(
    $lang,
    $rlLang->getPhrases(RL_LANG_CODE, $controller, array_keys($block_keys), $js_keys)
);
$rlSmarty->assign_by_ref('js_keys', $js_keys);
$rlSmarty->assign_by_ref('lang', $lang);

// Set language data
$page_info = $rlLang->replaceLangKeys($page_info, 'pages', ['name', 'title', 'meta_description', 'meta_keywords', 'h1']);
$blocks = $rlLang->replaceLangKeys($blocks, 'blocks', array('name'));
