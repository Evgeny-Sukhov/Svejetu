...
$root_categories = $rlCategories->getCategories(0, false, true, false);
$motors_categories = $rlCategories->getCategories(0,'motors');
$property_categories = $rlCategories->getCategories(0,'property');

//print_r($root_categories);
$rlSmarty -> assign_by_ref('root_categories', $root_categories);
$rlSmarty -> assign_by_ref('motor_categories', $motors_categories);
$rlSmarty -> assign_by_ref('property_categories', $property_categories);
...
if (!$_REQUEST['xjxfun']) {
    ...
    /* build featured accounts blocks */
