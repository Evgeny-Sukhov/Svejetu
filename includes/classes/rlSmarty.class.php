...
class rlSmarty extends Smarty
{
     ...
     * @param int $per_page or $perPage - per page items number
...
VS;
    ...
    public function mapsAPI($params)
    {
        ...
        if ($params['assign']) {
            $this->assign($params['assign'], $api_data);
        } else {
    ...
    public function registerFunctions()
    {
        ...
        $this->register_function('mapsAPI', array('rlSmarty', defined('REALM') && REALM == 'admin' ? 'adminMapsAPI' : 'mapsAPI'));
        $this->register_function('geoAutocompleteAPI', array('rlSmarty', defined('REALM') && REALM == 'admin' ? 'adminGeoAutocompleteAPI' : 'geoAutocompleteAPI'));
        $this->register_function('staticMap', array('rlSmarty', 'staticMap'));
