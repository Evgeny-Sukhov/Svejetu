...
class EditListing extends ManageListing
{
     ...
     */
    public function buildPrevStepURL($aParams)
    {
     ...
     */
    public function buildNextStepURL()
    {
    ...
    private function recountListings(&$account_info, &$plan_info)
    {
        ...
        if ($this->listingData['Crossed'] != implode(',', $post_crossed)) {
    ...
    private function notifyPendingStatus(&$account_info)
    {
        ...
        . $this->listingID;
        $details_link = '<a href="' . $details_url . '">' . $listing_title . '</a>';
