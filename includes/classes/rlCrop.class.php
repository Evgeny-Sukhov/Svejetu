...
class rlCrop
{
    public $_imgOrig = null;
    public $_imgFinal = null;
    public $_showDebug = false;
    public $gdInfo = array();
     ...
     * @access public
     */
    public function setDebugging($do = false)
    {
     ...
     * @access public
     */
    public function saveImage($filename, $quality = 90, $forcetype = '')
    {
     ...
     * @access public
     */
    public function showImage($type = 'png', $quality = 90)
    {
        if ($this->_imgFinal == null) {
     ...
     * @access public
     */
    public function cropBySize($x, $y, $position = ccCENTRE)
    {
        if ($x && $y) {
     ...
     * @access public
     */
    public function cropToSize($x, $y, $position = ccCENTRE)
    {
     ...
     * @access public
     */
    public function cropToDimensions($sx, $sy, $ex, $ey)
    {
     ...
     * @access public
     */
    public function cropByPercent($px, $py, $position = ccCENTRE)
    {
     ...
     * @access public
     */
    public function cropToPercent($px, $py, $position = ccCENTRE)
    {
     ...
     * @access public
     */
    public function cropByAuto($threshold = 254)
    {
        if ($threshold < 0) {
            $threshold = 0;
        }
     ...
     * @access public
     */
    public function flushImages($original = true)
    {
     ...
     * @return bool
     */
    public function _cropSize($ox, $oy, $nx, $ny, $position)
    {
        if ($this->_imgOrig == null) {
     ...
     * @return float
     */
    public function _getThresholdValue($im, $x, $y)
    {
     ...
     * @return string
     */
    public function _getExtension($file)
    {
        $ext = '';
        if (strrpos($file, '.')) {
     ...
     * @access private
     */
    public function _isSupported($filename, $extension, $function, $write = false)
    {
     ...
     * @access public
     */
    public function getGDInfo($justVersion = false)
    {
        $gdinfo = array();
