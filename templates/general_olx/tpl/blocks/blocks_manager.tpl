...
{if $pageInfo.Key == 'home' && (($block.Key|@strpos:'ltfb_' === 0 && $featured_listings_count >= $config.featured_per_page) || ($block.Plugin == 'listings_box' && $listings_box|@count > $config.featured_per_page))}
