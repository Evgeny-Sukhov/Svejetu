...
var mapClass = function(){
    ...
    this.prepareProviderOptions = function(){
        ...
        switch (rlConfig['map_provider']){
            ...
            case 'yandex':
                this.layerUrl = 'https://vec{s}.maps.yandex.net/tiles?l=map&v=4.55.2&z={z}&x={x}&y={y}&scale={retina}&lang=' + lng;
                this.providerOptions = {
    ...
    this.onPopupOpen = function(popup, address){
        ...
        var component = rlConfig['tpl_base'] + 'components/map-listing/map-listing.tmpl';
        var onOpen    = flFavoritesHandler;

        if (address.preview.component == 'account') {
            ajaxMode  = 'getAccountData';
            component = rlConfig['tpl_base'] + 'components/map-account/map-account.tmpl';
            onOpen    = null;
