...
if ($_GET['q'] == 'ext') {
    ...
    $transfer_fields = array('ID', 'Status', 'title', 'Type', 'Cat_title', 'Plan_ID', 'Featured_ID', 'Pay_date', 'Username', 'Account_ID', 'Date', 'Allow_photo', 'Allow_video', 'Plan_type');
    ...
    foreach ($data as $key => $value) {
        ...
        $data[$key]['Cat_title'] = $data[$key]['Tmp_name'] ? $data[$key]['Tmp_name'] . '<b> (' . $lang['pending'] . ')</b>' : $lang['categories+name+' . $data[$key]['Category_key']];
