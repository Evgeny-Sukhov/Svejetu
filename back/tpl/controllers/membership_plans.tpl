                        ...
                        <tr>
                            <td>
                                ...
                                {foreach from=$membership_services item='service' name='ms_services'}
                                    {if $service.ID|in_array:$sPost.services && $service.Key == 'add_listing'}
                                            ...
                                            {foreach from=$membership_services item='service' name='ms_services'}
                                                <td>
                                                    <div style="padding: 4px 8px 4px 0;">
                                                         <label><input id="ms_{$service.Key}" {if $service.ID|in_array:$sPost.services}checked="checked"{/if} style="margin-bottom: 0px;" type="checkbox" value="{$service.ID}" item-data="{$service.Key}" name="services[]" /> 
                                                         {$service.name}
                                                         </label>
                                                    </div>
                                                </td>
