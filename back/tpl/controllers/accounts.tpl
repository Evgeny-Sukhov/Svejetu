                ...
                columns: [
                    {
                        ...
                        renderer: function(username){
                            return "<a target='_blank' ext:qtip='" + lang['ext_click_to_view_details']
                                + "' href='" + rlUrlHome
                                + "index.php?controller=accounts&action=view&userid=" + account_id
                                + "'>" + username + "</a>";
                        }
                    },{
                        ...
                        renderer: function (val, obj, row){
                            ...
                            if (val != '') {
                                return '<img class="info" ext:qtip="'+row.data.Plan_info+'" alt="" src="'+rlUrlHome+'img/blank.gif" />&nbsp;&nbsp;<span ext:qtip="'+qtip+'">'+val+'</span>';
                            } else {
                                return '<span class="delete" ext:qtip="'+qtip+'" style="margin-left: 25px;">'+lang['ext_no_plan_set']+'</span>';
                            }
                        }
                    },{
